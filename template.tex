...
\begin{document}
	...
	\begin{frame}{Introduction --- What is a filesystem?}
		\begin{figure}
			...
			\caption{Ext2 on-disk representation \footfullcite{FossCoepExt2}}
		\end{figure}
	\end{frame}
	\note{
		A software component that imposes structure on the address space of one 
		or more storage elements or virtual disks so that applications may deal 
		with files.

		File systems are often supplied as operating system components, but are 
		also implemented and marketed as independent software components. \footnotecite{SniaDictionary}
	}
	...
	\begin{frame}{Introduction --- What is a filesystem?}
		\begin{figure}
			...
			\caption{Filesystem as a component of the Linux kernel \footfullcite{IbmVfs}}
		\end{figure}	
	\end{frame}
	...
	\begin{frame}{Introduction --- What is a versioning filesystem?}
		\begin{figure}
			...
			\caption{Example of file versioning in APFS \footfullcite{IGeeksBlog}}
		\end{figure}	
	\end{frame}
	\note{
	...
	\end{frame}
	\note{
		The replacement of multiple copies of data, at variable levels of 
		granularity, with references to a shared copy in order to save storage 
		space and/or data transferred. \footnotecite{SniaDictionary}
	}
